...
# Team members:Keanu, Abhi, Charlie, Isaac, Sam
# Date Created: 11/28/23

# Problem Description: The rover encounters obstacles and turns right until a certain time elapses, then it takes a picture from its camera when it finally stops, displays message on LCD screen.
# The robot utilizes the distance sensor to avoid obstacles.
...
import picamera #import camera function
